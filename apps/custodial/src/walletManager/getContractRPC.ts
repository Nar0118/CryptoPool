...
export const getContractRPC = (contractInfo: ContractInfo) : [Contract, Web3] => {
  try {
    const web3 = new Web3(new Web3.providers.HttpProvider(chains[contractInfo.chainId].rpcUrl));
